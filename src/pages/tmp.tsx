        ...
        <div className="container px-5 py-24 mx-auto">
          <div className="flex flex-wrap -m-12">
            <div className="p-12 md:w-1/2 flex flex-col items-start">
              <span className="inline-block py-1 px-2 rounded bg-red-50 text-red-500 text-xs font-medium tracking-widest">CATEGORY</span>
          ...
          <div className="flex items-center justify-center min-h-screen">
            <div className="max-w-sm w-full sm:w-1/2 lg:w-1/3 py-6 px-3">
              <div className="bg-white shadow-xl rounded-lg overflow-hidden">
                ...
                <div className="p-4">
                  <p className="tracking-wide text-xl font-bold text-gray-800">Article Title</p>
                  <p className="tracking-wide text-xs text-gray-400">Aug 8, 2015</p>
                  <p className="text-gray-600 text-md pt-2">When to Use Static Generation v.s. Server-side RenderingWhen to Use Static Generation v.s.</p>
                </div>
                <div className="p-5 flex flex-col space-y-4">
                  <div className="flex flex-col space-y-2">
                    <div className="flex space-x-2">
                      <div style={{ paddingTop: '0.1em', paddingBottom: '0.1rem' }} className="text-sm px-3 bg-red-200 text-red-800 rounded-full">Badge</div>
                      <div style={{ paddingTop: '0.1em', paddingBottom: '0.1rem' }} className="text-sm px-3 bg-green-200 text-green-800 rounded-full">Badge</div>
                      <div style={{ paddingTop: '0.1em', paddingBottom: '0.1rem' }} className="text-sm px-3 bg-yellow-200 text-yellow-800 rounded-full">Badge</div>
                    </div>
                  </div>
                </div>
              </div>
